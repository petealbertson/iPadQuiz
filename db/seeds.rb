...
Question.create(question_text: "How often do you make an online purchase?", quiz_id: 1, fact: "Apple sold 71.1 million iPads in 2013.")
Question.create(question_text: "Where do you do the majority of your web browsing?", quiz_id: 1, fact: "60% of moms who use iOS primarily use iPads.")
Question.create(question_text: "On which device do you do the majority of your web browsing?", quiz_id: 1, fact: "As of Oct 2013, over 170 million iPads have been sold.")
Question.create(question_text: "How often do you travel?", quiz_id: 1, fact: "For every Andriod tablet in use today in the world, there are 6.6 iPads.")
Question.create(question_text: "Which statement best describes your attitude towards video games?", quiz_id: 1, fact: "30% of casual social gamers who own iOS devices primarily use iPads.")
Question.create(question_text: "How many movies do you watch per month?", quiz_id: 1, fact: "IPad shoppers average $52.66 per item vs $21.86 per item for desktop and $23.80 for other mobile users.")
Question.create(question_text: "Do you have a kindle account?", quiz_id: 1, fact: "40% of Americans age 12 and up own an iPad, iPhone, or iPod.")
Question.create(question_text: "Do you have a Netflix account?", quiz_id: 1, fact: "IPad users account for 68% of all mobile shoppers.")
Question.create(question_text: "How many books have you read in the last year?", quiz_id: 1, fact: "It costs $1.50 annually to charge an iPad.")
Question.create(question_text: "How do you feel about newspapers?", quiz_id: 1, fact: "The first iPad was released April 3, 2010.")
Question.create(question_text: "How much time do you spend each day using an e-mail service?", quiz_id: 1, fact: "18% of social media content shared on iPads is food related.")
Question.create(question_text: "How often do you share content on social media outlets?", quiz_id: 1, fact: "18% of social media content shared on iPads is food related.")
